...
function checkFormMoptic() {
    ...
    var inputVal = "";
    if ($id_stavke.length == 0) {
        inputVal = $vrstaSociva + "###" + $materijal + "###" + $sph 
        ...
        inputVal = $id_stavke + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph 
		+ "###" + $cyl + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje;
        $.ajax({
            type: 'POST',
            url: 'update_row.php',
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
					...
					$("#vrsta_materijala option:contains(" + this.cells[2].innerHTML + ")").prop('selected', 'selected').change();
                    ...
                    document.getElementById("select13").value = this.cells[5].innerHTML;
                    ...
                    document.getElementById("mpc").value = this.cells[8].innerHTML;
					document.getElementById("broj_radnog_naloga").value = this.cells[9].innerHTML;
					document.getElementById("napomena").value = this.cells[10].innerHTML;
					document.getElementById("komitenti_radnje").value = this.cells[11].innerHTML;
