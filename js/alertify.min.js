           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
                    ...
                    document.getElementById("sph").value = this.cells[4].innerHTML;
                    document.getElementById("cyl").value = this.cells[5].innerHTML;
                    document.getElementById("add").value = this.cells[6].innerHTML;
