            ...
            if (this.cells[1].innerHTML == "Spec") {
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
                    ...
                    //$("#select3 option:contains(" + this.cells[9].innerHTML + ")").prop('selected', 'selected').change();
                    ...
                    document.getElementById("select11").value = this.cells[11].innerHTML;
                    document.getElementById("select12").value = this.cells[12].innerHTML;
                    ...
                    $("#select15 option:contains(" + this.cells[17].innerHTML + ")").prop('selected', 'selected').change();
                    $("#select16 option:contains(" + this.cells[18].innerHTML + ")").prop('selected', 'selected').change();
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
					...
					$("#select5 option:contains(" + this.cells[4].innerHTML + ")").prop('selected', 'selected').change();
                    ...
                    document.getElementById("select11").value = this.cells[9].innerHTML;
                    document.getElementById("select12").value = this.cells[10].innerHTML;
					...
					$("#dobavljac option:contains(" + this.cells[22].innerHTML + ")").prop('selected', 'selected').change();
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
				    ...
				    $("#select1 option:contains(" + this.cells[1].innerHTML + ")").prop('selected', 'selected').change();
                    $("#select2 option:contains(" + this.cells[2].innerHTML + ")").prop('selected', 'selected').change();
					$("#vrsta_materijala option:contains(" + this.cells[3].innerHTML + ")").prop('selected', 'selected').change();
...
$('#modalAddEssilor').on('hidden.bs.modal', function(e) {
	...
	$("#select5 option:contains()").prop('selected', 'selected').change();
    document.getElementById("segment").value = "";
    document.getElementById("select7").value = "";
    document.getElementById("select8").value = "";
    $("#select3 option:contains()").prop('selected', 'selected').change();
