...
function checkForm() {
    ...
    if ($id_stavke.length == 0) {
        inputVal = $lag_spec +"###"+ $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $mjesto_isporuke + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena;
        $.ajax({
            type: 'POST',
            url: 'addRow.php',
            dataType: 'json',
            ...
            error: function() {
                window.location.href = "../poloptic/index.php";
            }
        });
    } else {
           ...
           var btn = document.getElementById("dugmeNaruci");
			...
			if (this.cells[1].innerHTML == "Lager"){
                ...
                if (window.event.ctrlKey) {
				  ...
				  document.getElementById("select_lagspec").value = this.cells[1].innerHTML;
