...
function checkForm() {
    ...
    if ($id_stavke.length == 0) {
		...
		+ $tretman2 + "###" + $pd + "###" + $mjesto_isporuke + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $dobavljac;
        $.ajax({
            type: 'POST',
            url: 'add_row.php',
            dataType: 'json',
            ...
            if (this.cells[1].innerHTML == "Spec") {
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
                    ...
                    document.getElementById("mpc").value = this.cells[21].innerHTML;
					document.getElementById("broj_radnog_naloga").value = this.cells[22].innerHTML;
					document.getElementById("napomena").value = this.cells[23].innerHTML;
