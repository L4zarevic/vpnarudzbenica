...
function checkForm() {
    ...
    if ($id_stavke.length == 0) {
		...
		+ $tretman2 + "###" + $pd + "###" + $mjesto_isporuke + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena;
        $.ajax({
            type: 'POST',
            url: 'add_row.php',
            dataType: 'json',
            ...
            if (this.cells[1].innerHTML == "Spec") {
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
					...
					$("#mjesto_isporuke option:contains(" + this.cells[20].innerHTML + ")").prop('selected', 'selected').change();
...
$('#modalAdd').on('hidden.bs.modal', function(e) {
	...
	document.getElementById("mjesto_isporuke").value = "1"
...
function saveNote() {
        ...
        $.ajax({
            type: 'POST',
            url: 'orders_document_preview.php',
            dataType: 'json',
            data: ({
                note: napomena
            }),
