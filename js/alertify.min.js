            ...
            if (this.cells[1].innerHTML == "Spec") {
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
					...
					var vrsta_materijala = this.cells[9].innerHTML;
					...
					var tretman1 = this.cells[17].innerHTML;
					$("#select15 option:contains('" + tretman1 + "')").filter(function(i){ return $(this).text() === tretman1;}).attr("selected", true);
					var tretman2 = this.cells[18].innerHTML;
					$("#select16 option:contains('" + tretman2 + "')").filter(function(i){ return $(this).text() === tretman2;}).attr("selected", true);
...
$('#modalAddPol').on('hidden.bs.modal', function(e) {
    ...
    $("#select3 option:contains()").prop('selected', 'selected').change();
    ...
    $("#select15 option:contains()").prop('selected', 'selected').change();
    $("#select16 option:contains()").prop('selected', 'selected').change();
