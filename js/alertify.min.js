...
function deleteRow(e){e.stopPropagation();var a=event.srcElement.id;alertify.confirm("Potvrda brisanja","Da li želite da uklonite stavku?",function(){$.ajax({type:"POST",url:"delete_row.php",dataType:"json",data:{stavka:a},success:function(){location.reload()},error:function(){location.reload()}})},function(){}).set('labels', {
            ok: 'Da',
            cancel: 'Ne'
        });;}

function checkFormPolOptic() {
    var $id_stavke = "";
	var $lag_spec = "";
    var $odOsOu = "";
    var $vrstaSociva = "";
    ...
    var $napomena = "";
	var $komitenti_radnje = "";
	var $dobavljac = "";
	var $mjesto_isporuke = "";

    $lag_spec = document.getElementById("select_lagspec").value;
    $odOsOu = $('#select1').find("option:selected").text();
    $vrstaSociva = $('#select2').find("option:selected").text();
	if ($lag_spec=="Lager"){
		$materijal = document.getElementById("materijal_lager").value;
	}else{
        $materijal = document.getElementById("materijal_spec").value;
	}
    ...
    $add = document.getElementById("addDig").value;
	...
	$komitenti_radnje = document.getElementById("komitenti_radnje").value;
	$dobavljac = document.getElementById("dobavljac").value;
	$mjesto_isporuke = document.getElementById("mjesto_isporuke").value;

 
    if ($lag_spec == "Spec"){
    if (($odOsOu.length == 0) && ($vrstaSociva.length == 0) && ($indeks.length == 0) && ($materijal.length == 0) && ($dizajn.length == 0) && ($kolicina == 0) && ($mpc.length == 0)) {
    ...
    if ($materijal.length == 0) {
        document.getElementById('materijal_spec').focus();
        alertify.alert('Greška', 'Niste unijeli materijal');
        return false;
    }
    if ($indeks.length == 0) {
	...
	if ($lag_spec == "Lager"){
		if ($materijal.length == 0) {
            document.getElementById('materijal_lager').focus();
	...
	if ($dobavljac.length == 0) {
        document.getElementById('dobavljac').focus();
        alertify.alert('Informacija', "Nije izabran dobavljač");
        return false;
    }
    ...
    if ($id_stavke.length == 0) {
        inputVal = $lag_spec +"###"+ $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment 
		+ "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph 
		+ "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" 
		+ $tretman2 + "###" + $pd + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke;
        $.ajax({
            type: 'POST',
            url: 'add_row.php',
            dataType: 'json',
        ...
        inputVal = $id_stavke +"###"+ $lag_spec +"###"+ $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment 
		+ "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph 
		+ "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" 
		+ $tretman2 + "###" + $pd + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke;
        $.ajax({
...
function checkFormEssilor() {
    ...
    var inputVal = "";
    if ($id_stavke.length == 0) {
        inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment 
		+ "###" + $baza + "###" + $indeks + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph 
		+ "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" 
		+ $tretman2 + "###" + $pd + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke;
        $.ajax({
            type: 'POST',
        ...
        inputVal = $id_stavke + "###" + $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment 
		+ "###" + $baza + "###" + $indeks + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph 
		+ "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" 
		+ $tretman2 + "###" + $pd + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke;
        $.ajax({
...
function checkFormMoptic() {
	...
	$odOsOu = $('#select1').find("option:selected").text();
    $vrstaSociva = $('#select2').find("option:selected").text();
    $materijal = $('#vrsta_materijala').find("option:selected").text();
    ...
    if ($materijal.length == 0) {
        document.getElementById('vrsta_materijala').focus();
    ...
    var inputVal = "";
    if ($id_stavke.length == 0) {
        inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph 
		+ "###" + $cyl + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje;
        $.ajax({
            type: 'POST',
            url: 'add_row.php',
            dataType: 'json',
        ...
        inputVal = $id_stavke + "###" + $odOsOu + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph 
		+ "###" + $cyl + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje;
        $.ajax({
            type: 'POST',
            url: 'update_row.php',
...
function checkFormLenses(){
    ...
    if ($id_stavke.length == 0) {
        ...
        inputVal = $odOs + "###" + $tip + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $bc + "###" + $td + "###" + $jm + "###" + $kolicina + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena+ "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke;
        $.ajax({
            type: 'POST',
            url: 'add_row_lenses.php',
            dataType: 'json',
            data: ({
                stavka: inputVal
            }),
        ...
        inputVal = $odOs + "###" + $tip + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $bc + "###" + $td + "###" + $jm + "###" + $kolicina + "###" + $mpc + "###" + $broj_radnog_naloga + "###" + $napomena + "###" + $komitenti_radnje + "###" + $dobavljac + "###" + $mjesto_isporuke + "###" + $id_stavke;
        $.ajax({
            type: 'POST',
            url: 'update_row_lenses.php',
            dataType: 'json',
            data: ({
                stavka: inputVal
            }),
    ...
    for (var i = 1; i < table.rows.length; i++) {
        ...
        table.rows[i].onclick = function() {
           ...
           var btn = document.getElementById("dugmeNaruci");
            ...
            if (this.cells[1].innerHTML == "Spec") {
				document.getElementById("select10").value = "";

                if (window.event.ctrlKey) {
                  document.getElementById("id_stavke").value = "";
			      btn.innerHTML = 'Sačuvaj stavku';
			      $("h4#add_edit_label").text("Dodaj novi zapis");
                }else{
                    document.getElementById("id_stavke").value = this.id;
				    btn.innerHTML = 'Izmijeni stavku';
					$("h4#add_edit_label").text("Izmijeni zapis");
				}
                    $("#select_lagspec option:contains(" + this.cells[1].innerHTML + ")").prop('selected', 'selected').change();
				    document.getElementById("select1").value = this.cells[2].innerHTML;
                    $("#select2 option:contains(" + this.cells[3].innerHTML + ")").prop('selected', 'selected').change();
                    $("#select4 option:contains(" + this.cells[4].innerHTML + ")").prop('selected', 'selected').change();
                    document.getElementById("select5").value = this.cells[5].innerHTML;
                    document.getElementById("segment").value = this.cells[6].innerHTML;
                    document.getElementById("select7").value = this.cells[7].innerHTML;
                    document.getElementById("select8").value = this.cells[8].innerHTML;
					document.getElementById("materijal_spec").value = this.cells[9].innerHTML;
                    
                    var precnik = this.cells[10].innerHTML;
                    if (precnik.indexOf('/') >= 0) {
                        ...
                        document.getElementById("select9").value = this.cells[10].innerHTML;
                    }

                    document.getElementById("sph").value = this.cells[11].innerHTML;
                    document.getElementById("cyl").value = this.cells[12].innerHTML;
                    document.getElementById("ugaoCilindra").value = this.cells[13].innerHTML;
                    document.getElementById("addDig").value = this.cells[14].innerHTML;
                    document.getElementById("select14").value = this.cells[15].innerHTML;
                    document.getElementById("kolicina").value = this.cells[16].innerHTML;
					document.getElementById("tretman1").value = this.cells[17].innerHTML;
					document.getElementById("tretman2").value = this.cells[18].innerHTML;
                   
                    document.getElementById("pd").value = this.cells[19].innerHTML;
					...
					document.getElementById("komitenti_radnje").value = this.cells[23].innerHTML;
					$("#dobavljac option:contains(" + this.cells[24].innerHTML + ")").prop('selected', 'selected').change();
					document.getElementById("mjesto_isporuke").value = this.cells[25].innerHTML;
					$('#modalAddPol').modal({ show: true });

            }
			
			if (this.cells[1].innerHTML == "Lager"){
                if (window.event.ctrlKey) {
                    document.getElementById("id_stavke").value = "";
					btn.innerHTML = 'Sačuvaj stavku';
					$("h4#add_edit_label").text("Dodaj novi zapis");
				  ...
				  $("#select_lagspec option:contains(" + this.cells[1].innerHTML + ")").prop('selected', 'selected').change();
				  document.getElementById("select1").value = this.cells[2].innerHTML;
				  document.getElementById("materijal_lager").value = this.cells[9].innerHTML;
                  document.getElementById("select14").value = this.cells[15].innerHTML;
                  document.getElementById("kolicina").value = this.cells[16].innerHTML
				  document.getElementById("mjesto_isporuke").value = this.cells[20].innerHTML;
				  document.getElementById("mpc").value = this.cells[20].innerHTML;
			      document.getElementById("broj_radnog_naloga").value = this.cells[21].innerHTML;
				  document.getElementById("napomena").value = this.cells[22].innerHTML;
				  document.getElementById("komitenti_radnje").value = this.cells[23].innerHTML;
...
function updateEntireRowEssilor() {
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
					...
					document.getElementById("dizajn").value = this.cells[3].innerHTML;
                    ...
                    var precnik = this.cells[8].innerHTML;
                    if (precnik.indexOf('/') >= 0) {
                        var DtlStr = precnik.split('/');
                        document.getElementById("select9").value = DtlStr[0];
                        document.getElementById("select10").value = DtlStr[1];
                    } else {
                        document.getElementById("select9").value = this.cells[8].innerHTML;
                    }

                    document.getElementById("sph").value = this.cells[9].innerHTML;
                    document.getElementById("cyl").value = this.cells[10].innerHTML;
                    document.getElementById("ugaoCilindra").value = this.cells[11].innerHTML;
                    document.getElementById("select13").value = this.cells[12].innerHTML;
                    document.getElementById("select14").value = this.cells[13].innerHTML;
                    document.getElementById("kolicina").value = this.cells[14].innerHTML;
					document.getElementById("tretman1").value = this.cells[15].innerHTML;
					document.getElementById("tretman2").value = this.cells[16].innerHTML;
                    document.getElementById("pd").value = this.cells[17].innerHTML;
					...
					document.getElementById("komitenti_radnje").value = this.cells[21].innerHTML;
					document.getElementById("dobavljac").value = this.cells[22].innerHTML;
					document.getElementById("mjesto_isporuke").value = this.cells[23].innerHTML;
					$('#modalAddEssilor').modal({ show: true });
...
function updateEntireRowMoptic() {
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
				    ...
				    document.getElementById("select1").value = this.cells[1].innerHTML;
                    document.getElementById("select2").value = this.cells[2].innerHTML;
					document.getElementById("vrsta_materijala").value = this.cells[3].innerHTML;
                    document.getElementById("select11").value = this.cells[4].innerHTML;
                    document.getElementById("select12").value = this.cells[5].innerHTML;
                    document.getElementById("select13").value = this.cells[6].innerHTML;
                    document.getElementById("select14").value = this.cells[7].innerHTML;
                    document.getElementById("kolicina").value = this.cells[8].innerHTML;
					...
					document.getElementById("komitenti_radnje").value = this.cells[12].innerHTML;
					$('#modalAddMoptic').modal({ show: true });
           ...
           var btn = document.getElementById("dugmeNaruci");
                ...
                if (window.event.ctrlKey) {
			      ...
			      $("h4#add_edit_label").text("Dodaj novi zapis");
				    ...
				    document.getElementById("select1").value = this.cells[1].innerHTML;
                    document.getElementById("tip").value = this.cells[2].innerHTML;
					document.getElementById("sph").value = this.cells[3].innerHTML;
                    document.getElementById("cyl").value = this.cells[4].innerHTML;
                    document.getElementById("ugao").value = this.cells[5].innerHTML;
                    document.getElementById("bc").value = this.cells[6].innerHTML;
                    document.getElementById("td").value = this.cells[7].innerHTML;
                    ...
                    document.getElementById("mpc").value = this.cells[10].innerHTML;
					document.getElementById("broj_radnog_naloga").value = this.cells[11].innerHTML;
					document.getElementById("napomena").value = this.cells[12].innerHTML;
					document.getElementById("komitenti_radnje").value = this.cells[13].innerHTML;
					document.getElementById("dobavljac").value = this.cells[14].innerHTML;
					document.getElementById("mjesto_isporuke").value = this.cells[15].innerHTML;
					$('#modalAddLenses').modal({ show: true });
...
$('#modalAddPol').on('hidden.bs.modal', function(e) {
    var btn = document.getElementById("dugmeNaruci");
    btn.innerHTML = 'Sačuvaj stavku';
    $("h4#add_edit_label").text("Dodaj novi zapis");

    document.getElementById("id_stavke").value = ""
	$("#select4 option:contains('Lager')").prop('selected', 'selected').change();
    document.getElementById("select1").value = "OD"
	document.getElementById("select2").value = ""
    $("#select4 option:contains()").prop('selected', 'selected').change();
	document.getElementById("materijal_lager").value = "";
    ...
    document.getElementById("materijal_spec").value = "";
    document.getElementById("select9").value = "";
    document.getElementById("select10").value = "";
    document.getElementById("sph").value = "";
    document.getElementById("cyl").value = "";
    document.getElementById("ugaoCilindra").value = "";
    document.getElementById("addDig").value = "";
    document.getElementById("select14").value = "kom";
    document.getElementById("kolicina").value = "";
    document.getElementById("tretman1").value = "";
	document.getElementById("tretman2").value = "";
    document.getElementById("pd").value = "";
	document.getElementById("mjesto_isporuke").value = ""
	document.getElementById("komitenti_radnje").value = ""
    document.getElementById("mpc").value = "";
    document.getElementById("broj_radnog_naloga").value = "";
    document.getElementById("napomena").value = "";
});

$('#modalAddEssilor').on('hidden.bs.modal', function(e) {
    var btn = document.getElementById("dugmeNaruci");
    btn.innerHTML = 'Sačuvaj stavku';
    $("h4#add_edit_label").text("Dodaj novi zapis");
    document.getElementById("id_stavke").value = ""
    document.getElementById("select1").value = "OD"
	document.getElementById("select2").value = ""
    document.getElementById("dizajn").value = "";
	document.getElementById("select5").value = "";
    document.getElementById("segment").value = "";
    document.getElementById("select7").value = "";
    document.getElementById("select8").value = "";
    ...
    document.getElementById("cyl").value = "";
    document.getElementById("ugaoCilindra").value = "";
    document.getElementById("select13").value = "";
    document.getElementById("select14").value = "kom";
    document.getElementById("kolicina").value = "";
    document.getElementById("tretman1").value = "";
    document.getElementById("tretman2").value = "";
...
$('#modalAddHoya').on('hidden.bs.modal', function(e) {
    var btn = document.getElementById("dugmeNaruci");
    btn.innerHTML = 'Sačuvaj stavku';
    $("h4#add_edit_label").text("Dodaj novi zapis");
    document.getElementById("id_stavke").value = ""
...
$('#modalAddMoptic').on('hidden.bs.modal', function(e) {
    var btn = document.getElementById("dugmeNaruci");
    btn.innerHTML = 'Sačuvaj stavku';
    $("h4#add_edit_label").text("Dodaj novi zapis");
    document.getElementById("id_stavke").value = ""
	...
	document.getElementById("select2").value = ""
    document.getElementById("vrsta_materijala").value = ""
    document.getElementById("select11").value = "";
    document.getElementById("select12").value = "";
    document.getElementById("select13").value = "";
    document.getElementById("select14").value = "kom";
    document.getElementById("kolicina").value = "";
    document.getElementById("mpc").value = "";
...
$('#modalAddLenses').on('hidden.bs.modal', function(e) {
    var btn = document.getElementById("dugmeNaruci");
    btn.innerHTML = 'Sačuvaj stavku';
    $("h4#add_edit_label").text("Dodaj novi zapis");
    document.getElementById("id_stavke").value = ""
    ...
    document.getElementById("sph").value = "";
    document.getElementById("cyl").value = "";
    document.getElementById("ugao").value = "";
    document.getElementById("bc").value = "";
	document.getElementById("td").value = "";
    document.getElementById("select14").value = "kutija";
    document.getElementById("kolicina").value = "";
	document.getElementById("mjesto_isporuke").value = ""
	document.getElementById("komitenti_radnje").value = ""
    document.getElementById("mpc").value = "";
    document.getElementById("broj_radnog_naloga").value = "";
    document.getElementById("napomena").value = "";
	document.getElementById("dobavljac").value = "";
});


function sendPolopticSarajevo(){
	 alertify.prompt("Potvrda slanja (Pol Optic - Sarajevo)", "Za: office.sa@poloptic.com </br> Poruka:", "",
        function(evt, value) {
		...
		var message = value; 
           ...
           $.ajax({
            ...
            error: function() {
                window.location.href = "index.php?msg=0";
            }
        });
        },
        function() {
...
function sendPolopticBeograd(){
	 alertify.prompt("Potvrda slanja (Pol Optic - Beograd)", "Za: order@poloptic.com </br> Poruka:", "",
        function(evt, value) {
...
function sendPolopticNoviSad(){
	 alertify.prompt("Potvrda slanja (Pol Optic - Novi Sad)", "Za: office.ns@poloptic.com </br> Poruka:", "",
        function(evt, value) {
...
function sendPolopticBojana(){
	 alertify.prompt("Potvrda slanja (Pol Optic - Bojana C.)", "Za: bojana.c@poloptic.com </br> Poruka:", "",
        function(evt, value) {
...
function sendEssilorBiH(){
	 alertify.prompt("Potvrda slanja (Essilor - BiH)", "Za: narudzba.essilor@gmail.com </br> Poruka:", "",
        function(evt, value) {
...
function sendEssilorSrbija(){
	 alertify.prompt("Potvrda slanja (Essilor - BiH)", "Za: porudzbine@essilor.rs </br> Poruka:", "",
        function(evt, value) {
...
function sendHoyaSrbija(){
	 alertify.prompt("Potvrda slanja (Hoya - Srbija)", "Za: office@mobioptika.rs </br> Poruka:", "",
        function(evt, value) {
...
function saveOrderMoptic(){
	
	
	 alertify.confirm("Potvrda narudžbenice (M-Optic)", "Da li želite na sačuvate naružbenicu?",
        function() {
			
		window.open('print_order_moptic.php','_blank');
		
		window.location.href = "save_order_moptic.php";
...
function sendJohnsonJohnsonBiH(){
	 alertify.prompt("Potvrda slanja (Johnson & Johnson - BiH)", "Za: oktal-pharma@oktal-pharma.ba </br> Poruka:", "",
        function(evt, value) {
		...
		var message = value; 
           ...
           $.ajax({
            type: 'POST',
            url: 'mail_johnson_johnson_bih.php',
            dataType: 'json',
            data: ({
              user_message: message
            }),
...
function sendJohnsonJohnsonSrbija(){
	 alertify.prompt("Potvrda slanja (Johnson & Johnson - Srbija)", "Za: office@oktal-pharma.rs </br> Poruka:", "",
        function(evt, value) {
		...
		var message = value; 
           ...
           $.ajax({
            type: 'POST',
            url: 'mail_johnson_johnson_srb.php',
            dataType: 'json',
            data: ({
              user_message: message
            }),
...
function sendAlconBiH(){
	 alertify.prompt("Potvrda slanja (Alcon - BiH)", "Za: provision.vgd@gmail.com </br> Poruka:", "",
        function(evt, value) {
...
function sendAlconSrbija(){
	 alertify.prompt("Potvrda slanja (Alcon - Srbija)", "Za: kontaktna.sociva@opticus-oculus.com </br> Poruka:", "",
        function(evt, value) {
...
function sendBauschLombBiH(){
	 alertify.prompt("Potvrda slanja (Bausch & Lomb - BiH)", "Za: rica-grossoptic@blic.net </br> Poruka:", "",
        function(evt, value) {
...
function sendBauschLombSrbija(){
	 alertify.prompt("Potvrda slanja (Bausc & Lomb - Srbija)", "Za: (nije definisano) </br> Poruka:", "",
        function(evt, value) {
