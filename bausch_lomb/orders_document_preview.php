...
if ($realizovana == "&check;") {
    ...
    echo "</table></br></br> <center><button type='button' class='btn btn-success' onClick=window.location.href='\../bausch_lomb/orders_document_preview.php?id=$id_stavke&realizovano=true'>Potvrdi prispeće ove narudžbe</button></center>";
}
