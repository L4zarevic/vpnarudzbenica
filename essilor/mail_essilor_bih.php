...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt1 = $con->prepare('SELECT * FROM mojaopt_vpnarudzbenica.narudzbenica_essilor WHERE dobavljac="essilor-bih"');
  ...
  $message = "Narudzbenica - Essilor BiH \n";
  ...
  $stmt2 = $con->prepare('INSERT INTO mojaopt_vpnarudzbenica.istorijat_essilor (IDKorisnika,narudzba,datum,dobavljac) VALUES (?,?,?,"Essilor - BiH")');
  $stmt2->bind_param('iss', $idKorisnika, $schema_insert, date("Y-m-d"));
  $stmt2->execute();

  $stmt = $con->prepare('DELETE FROM `narudzbenica_essilor` WHERE dobavljac = "essilor-bih"');
