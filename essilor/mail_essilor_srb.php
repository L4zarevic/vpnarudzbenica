...
FROM mojaopt_vpnarudzbenica.narudzbenica_essilor
WHERE dobavljac="essilor-srbija"');
...
$schema_insert .= '<th>Mesto isporuke</th>';
...
$to="";
$stmt_email = $con->prepare('SELECT email FROM email_dobavljaca WHERE naziv_dobavljaca="essilor-srbija"');
$stmt_email->execute();
$result_email = $stmt_email->get_result();
while ($row_email = $result_email->fetch_object()) {
  $to = $row_email->email;
}
//$to = "porudzbine@essilor.rs";
///////////////////////////////////
...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt1 = $con->prepare('SELECT * FROM mojaopt_vpnarudzbenica.narudzbenica_essilor WHERE dobavljac="essilor-srbija"');
  ...
  $message = "Narudzbenica - Essilor Srbija \n";
  ...
  $stmt2 = $con->prepare('INSERT INTO mojaopt_vpnarudzbenica.istorijat_essilor (IDKorisnika,narudzba,datum,dobavljac) VALUES (?,?,?,"Essilor - Srbija")');
  $stmt2->bind_param('iss', $idKorisnika, $schema_insert, date("Y-m-d"));
  $stmt2->execute();

  $stmt = $con->prepare('DELETE FROM `narudzbenica_essilor` WHERE dobavljac = "essilor-srbija"');
