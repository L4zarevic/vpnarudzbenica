...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt1 = $con->prepare('SELECT * FROM mojaopt_vpnarudzbenica.narudzbenica_alcon WHERE dobavljac="alcon-srbija"');
  ...
  $message = "Narudzbenica - Alcon Srbija \n";
  ...
  $stmt2 = $con->prepare('INSERT INTO mojaopt_vpnarudzbenica.istorijat_alcon (IDKorisnika,narudzba,datum,dobavljac) VALUES (?,?,?,"Alcon - Srbija")');
  $stmt2->bind_param('iss', $idKorisnika, $schema_insert, date("Y-m-d"));
  $stmt2->execute();

  $stmt = $con->prepare('DELETE FROM `narudzbenica_alcon` WHERE dobavljac = "alcon-srbija"');
