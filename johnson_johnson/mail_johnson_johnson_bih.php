...
WHERE dobavljac="johnson_johnson-bih"');
...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt1 = $con->prepare('SELECT * FROM mojaopt_vpnarudzbenica.narudzbenica_jj WHERE dobavljac="johnson_johnson-bih"');
  ...
  $message = "Narudzbenica - Johnson & Johnson BiH \n";
  ...
  $stmt2 = $con->prepare('INSERT INTO mojaopt_vpnarudzbenica.istorijat_jj (IDKorisnika,narudzba,datum,dobavljac) VALUES (?,?,?,"Johnson & Johnson - BiH")');
  $stmt2->bind_param('iss', $idKorisnika, $schema_insert, date("Y-m-d"));
  $stmt2->execute();

  $stmt = $con->prepare('DELETE FROM `narudzbenica_jj` WHERE dobavljac = "johnson_johnson-bih"');
