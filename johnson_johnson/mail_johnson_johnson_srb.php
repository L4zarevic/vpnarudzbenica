...
FROM mojaopt_vpnarudzbenica.narudzbenica_jj
WHERE dobavljac="johnson_johnson-srbija"');
...
$to="";
$stmt_email = $con->prepare('SELECT email FROM email_dobavljaca WHERE naziv_dobavljaca="johnson_johnson-srbija"');
$stmt_email->execute();
$result_email = $stmt_email->get_result();
while ($row_email = $result_email->fetch_object()) {
  $to = $row_email->email;
}
//$to = "office@oktal-pharma.rs";
//////////////////////////////////
...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt1 = $con->prepare('SELECT * FROM mojaopt_vpnarudzbenica.narudzbenica_jj WHERE dobavljac="johnson_johnson-srbija"');
  ...
  $message = "Narudzbenica - Johnson & Johnson Srbija \n";
  ...
  $stmt2 = $con->prepare('INSERT INTO mojaopt_vpnarudzbenica.istorijat_jj (IDKorisnika,narudzba,datum,dobavljac) VALUES (?,?,?,"Johnson & Johnson - Srbija")');
  $stmt2->bind_param('iss', $idKorisnika, $schema_insert, date("Y-m-d"));
  $stmt2->execute();

  $stmt = $con->prepare('DELETE FROM `narudzbenica_jj` WHERE dobavljac = "johnson_johnson-srbija"');
