...
$stmt = $con->prepare('UPDATE narudzbenica_jj SET od_os=?,tip=?,sph=?,cyl=?,ugao=?,bc=?,td=?,jm=?,kolicina=?,mpc=?,broj_naloga=?,napomena=?,komitenti_radnje=?,dobavljac=?,mjesto_isporuke=? WHERE ID=?');
