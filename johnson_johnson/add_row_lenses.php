...
$stmt = $con->prepare('INSERT INTO narudzbenica_jj (od_os,tip,sph,cyl,ugao,bc,td,jm,kolicina,mpc,broj_naloga,napomena,komitenti_radnje,dobavljac,mjesto_isporuke) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
